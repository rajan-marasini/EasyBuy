    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80 shadow-sm">
            <div className="container mx-auto flex h-16 items-center justify-between px-4">
                ...
                <Link
                    href="/"
                    className="text-2xl font-black tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
                >
                    EasyBuy
                </Link>
                ...
                <div className="hidden flex-1 md:flex justify-center max-w-md mx-8">
                    <div className="relative w-full">
                        ...
                        <Input
                            ...
                            className="pl-9 rounded-full bg-gradient-to-r from-zinc-50 to-zinc-100 border-none h-10 w-full focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
                            value={searchQuery}
