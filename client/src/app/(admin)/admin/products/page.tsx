...
export default function ManageProductsPage() {
    ...
    const { data: productsData, isLoading, isError } = useAdminProducts(page);
            ...
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-6 bg-red-50/50 rounded-3xl border border-red-100">
                ...
                <div className="text-center">
                    ...
                    <p className="text-zinc-500 mt-1 max-w-xs">
                        We couldn&apos;t reach the server to fetch your
                        products.
                    </p>
                </div>
                <Button
    ...
    return (
        <div className="space-y-8 pb-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-extrabold tracking-tight text-zinc-900 bg-gradient-to-r from-zinc-900 to-zinc-500 bg-clip-text text-transparent">
                        Inventory Master
                    </h1>
                ...
                <AlertDialogContent className="rounded-[2rem] border-none shadow-2xl p-8 max-w-md">
                    <AlertDialogHeader className="space-y-4">
                        ...
                        <AlertDialogDescription className="text-zinc-500 text-center text-lg leading-relaxed">
                            ...
                            the product from your catalog. This action cannot be
                            undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
