        ...
        (() => {
            ...
            createOrder(orderData, {
                ...
                onError: (error: any) => {
                    ...
                    hasCreatedOrder.current = false; // Allow retry if it failed? Or keep it true to avoid double payment issues?
                    // Actually if it failed, we want them to be able to try again if they refresh.
                },
            });
        })();
                ...
                {status === "processing" && (
                    <>
                        ...
                        <p className="text-zinc-500 font-medium">
                            Please wait while we confirm your payment and create
                            your order.
                        </p>
                    </>
                )}
                    ...
                    <>
                        <div className="flex justify-center">
                            <div className="h-20 w-20 rounded-full bg-red-100 flex items-center justify-center">
                                <span className="text-4xl text-red-600 font-black">
                                    X
                                </span>
                            </div>
                        </div>
                        ...
                        <p className="text-zinc-500 font-medium">
                            We couldn&apos;t finalize your order. Please contact
                            support if your payment was deducted.
                        </p>
                        <Button
                            variant="outline"
